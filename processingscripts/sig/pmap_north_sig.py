...
for i in range(0, 100):
    print(i)
    try:
        data = np.load('/data/user/wluszczak/multiflare_csky/gridmaps/injmaps/d%s/%sflare/%s/combinedmap_north_%s.npy'%(rho, Nflare, i,i), allow_pickle=True)
        ...
        np.save('/data/user/wluszczak/multiflare_csky/gridmaps/injmaps/d%s/%sflare/%s/pmap_north_%s.npy'%(rho, Nflare, i, i), pmap)
